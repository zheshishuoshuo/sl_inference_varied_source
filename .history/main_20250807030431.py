...
def main() -> None:
    ...
    sampler = run_mcmc(grids, logM_sps_obs, nsteps=nsteps, nwalkers=20, backend_file="chains_eta_new_table_no_eta_variedmswith_eta2.h5", parallel=True, nproc=mp.cpu_count()-3)
